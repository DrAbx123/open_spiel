...
// https://en.wikipedia.org/wiki/gi_tcg It uses a standard 54-card deck
...
// For more, see https://rezunli96.github.io/blog/GITCG_count.html
//
...
class GITCGState : public State {
 public:
  ...
  std::unique_ptr<State> Clone() const override {
    return absl::make_unique<GITCGState>(*this);
  }
